...
const appCss = "/assets/styles-Dc1yP77K.css";
...
const $$splitComponentImporter$b = () => import("./video-test-B9irY1oe.js");
const Route$b = createFileRoute("/video-test")({
  head: () => ({
    meta: [{
      title: "Video Test — IQNAAX"
    }, {
      name: "description",
      content: "Compare local uploaded MP4 playback with a public MP4 audio test."
    }]
  }),
  component: lazyRouteComponent($$splitComponentImporter$b, "component")
});
const airLab = "/assets/air-lab-C3GjQ56w.jpg";
const $$splitComponentImporter$a = () => import("./services-DUQ1yi7z.js");
const Route$a = createFileRoute("/services")({
  head: () => ({
    meta: [{
      ...
      name: "description",
      content: "Explore IQNAAX services: AIR-Lab Robots, Customized Hardware Solutions, AR/VR Content, LMS for institutions, Next-Gen Robotics distribution and turnkey delivery."
    }, {
      property: "og:title",
      content: "Services — IQNAAX"
    }, {
      property: "og:description",
      content: "AIR-Lab Robots, Custom Hardware, AR/VR, LMS and Next-Gen Robotics — end-to-end services for enterprises and institutions."
    }, {
      property: "og:image",
      content: airLab
    }]
...
const $$splitComponentImporter$9 = () => import("./products-ChRsPmxQ.js");
const Route$9 = createFileRoute("/products")({
  head: () => ({
    meta: [{
      ...
      name: "description",
      content: "Browse IQNAAX's wholesale catalog: humanoid robots, collaborative arms, quadrupeds, educational robots and 3D printers from Nuwa, Elephant Robotics, Unitree and more."
    }, {
      property: "og:title",
      content: "Products — IQNAAX Wholesale Robotics"
    }, {
      property: "og:description",
...
const $$splitComponentImporter$8 = () => import("./login-D549G7E5.js");
const Route$8 = createFileRoute("/login")({
  head: () => ({
    meta: [{
      ...
      name: "description",
      content: "Admin login for IQNAAX Robotics."
    }, {
      property: "og:title",
      content: "Admin Login — IQNAAX Robotics"
    }]
  }),
  component: lazyRouteComponent($$splitComponentImporter$8, "component")
});
const $$splitComponentImporter$7 = () => import("./lab-setup-CzZaiPVN.js");
const Route$7 = createFileRoute("/lab-setup")({
  head: () => ({
    meta: [{
      title: "Custom Lab Setup for Schools & Colleges | IQNAAX"
    }, {
      name: "description",
      content: "IQNAAX designs and commissions custom AI, Robotics and IoT labs for schools, colleges and universities — tailored to your curriculum and budget."
    }, {
      property: "og:title",
      content: "Custom Robotics Lab Setup | IQNAAX"
    }, {
      property: "og:description",
      content: "Turnkey AI & Robotics labs for institutions. Designed, supplied and commissioned."
    }, {
      property: "og:image",
      content: "/lab-overview.jpg"
    }]
  }),
  component: lazyRouteComponent($$splitComponentImporter$7, "component")
});
const $$splitComponentImporter$6 = () => import("./contact-gVLHwgJi.js");
const Route$6 = createFileRoute("/contact")({
  head: () => ({
    meta: [{
      ...
      property: "og:title",
      content: "Contact IQNAAX"
    }, {
      property: "og:description",
      content: "Wholesale quotes and custom lab consultations."
    }]
  }),
  component: lazyRouteComponent($$splitComponentImporter$6, "component")
});
const $$splitComponentImporter$5 = () => import("./blog-DH0pSX80.js");
const Route$5 = createFileRoute("/blog")({
  head: () => ({
    meta: [{
      ...
      name: "description",
      content: "Latest robotics and AI articles from IQNAAX."
    }]
  }),
  component: lazyRouteComponent($$splitComponentImporter$5, "component")
});
const $$splitComponentImporter$4 = () => import("./admin-CT6fzxts.js");
const Route$4 = createFileRoute("/admin")({
  head: () => ({
    meta: [{
      ...
      name: "description",
      content: "IQNAAX admin dashboard."
    }, {
      property: "og:title",
      content: "Admin Dashboard — IQNAAX Robotics"
    }]
  }),
  component: lazyRouteComponent($$splitComponentImporter$4, "component")
});
const $$splitComponentImporter$3 = () => import("./about-0H08mN1k.js");
const Route$3 = createFileRoute("/about")({
  head: () => ({
    meta: [{
      ...
      name: "description",
      content: "IQNAAX is a wholesale robotics distributor and turnkey AI & Robotics lab builder partnering with the world's leading robot manufacturers."
    }, {
      property: "og:title",
      content: "About IQNAAX"
    }, {
      property: "og:description",
...
const $$splitComponentImporter$2 = () => import("./index-rMzVHBHJ.js");
const Route$2 = createFileRoute("/")({
  head: () => ({
    meta: [{
      ...
      name: "description",
      content: "IQNAAX distributes next-generation humanoids, cobots, and quadrupeds at wholesale, and builds custom AI & robotics labs for schools and colleges."
    }, {
      property: "og:title",
      content: "IQNAAX — Wholesale Robotics & Lab Setup"
    }, {
      property: "og:description",
      content: "Distributors of humanoids, cobots & quadrupeds. Custom AI & robotics labs for institutions."
    }]
  }),
  component: lazyRouteComponent($$splitComponentImporter$2, "component")
});
const $$splitComponentImporter$1 = () => import("./products._id-B1591U9D.js");
const Route$1 = createFileRoute("/products/$id")({
  head: () => ({
    meta: [{
      title: "Product Details — IQNAAX"
    }]
  }),
  component: lazyRouteComponent($$splitComponentImporter$1, "component")
});
const $$splitComponentImporter = () => import("./blog._id-Dwr5K3nR.js");
const Route2 = createFileRoute("/blog/$id")({
  head: () => ({
    meta: [{
      title: "Blog — IQNAAX"
    }]
...
const VideoTestRoute = Route$b.update({
  id: "/video-test",
  path: "/video-test",
...
const ProductsRoute = Route$9.update({
  id: "/products",
  path: "/products",
  getParentRoute: () => Route$c
});
...
const LabSetupRoute = Route$7.update({
  id: "/lab-setup",
  path: "/lab-setup",
  getParentRoute: () => Route$c
});
...
const ProductsIdRoute = Route$1.update({
  id: "/$id",
  path: "/$id",
  getParentRoute: () => ProductsRoute
});
const BlogIdRoute = Route2.update({
  id: "/$id",
  path: "/$id",
